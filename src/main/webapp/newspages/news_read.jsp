...
<div id="header">
    <div id="top_login">
        ...
        <a href="../index.html" class="login_link">返回首页</a> <img src="/Images/friend_logo.gif" alt="Google"
                                                                 id="friend_logo"/></div>
    <div id="nav">
        ...
        <div class="content">
            <ul class="classlist">
                <table width="80%" align="center">
                    <tr width="100%">
                        <td colspan="2" align="center">${news.title}</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr/>
                    ...
                    <tr>
                        <td align="center">${news.time}</td>
                        <td align="left">${news.nickName}</td>
                    </tr>
                    <tr>
